...
def test_get_visible_seats_returns_correct_number():
	test_map = [['.', '.', '.', '.', '.', '.', '.', '#', '.'], ['.', '.', '.', '#', '.', '.', '.', '.', '.'], ['.', '#', '.', '.', '.', '.', '.', '.', '.'], ['.', '.', '.', '.', '.', '.', '.', '.', '.'], ['.', '.', '#', 'L', '.', '.', '.', '.', '#'], ['.', '.', '.', '.', '#', '.', '.', '.', '.'], ['.', '.', '.', '.', '.', '.', '.', '.', '.'], ['#', '.', '.', '.', '.', '.', '.', '.', '.'], ['.', '.', '.', '#', '.', '.', '.', '.', '.']]
	assert get_visible_seats(test_map, 3, 4) == 8
	test_map = [['.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.'], ['.', 'L', '.', 'L', '.', '#', '.', '#', '.', '#', '.', '#', '.'], ['.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.']]
	assert get_visible_seats(test_map, 1, 1) == 0
	test_map = [['.', '#', '#', '.', '#', '#', '.'], ['#', '.', '#', '.', '#', '.', '#'], ['#', '#', '.', '.', '.', '#', '#'], ['.', '.', '.', 'L', '.', '.', '.'], ['#', '#', '.', '.', '.', '#', '#'], ['#', '.', '#', '.', '#', '.', '#'], ['.', '#', '#', '.', '#', '#', '.']]
	assert get_visible_seats(test_map, 3, 3) == 0